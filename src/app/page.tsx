...
const perks = [
  {
    ...
    description:
      "Get your assets delivered to your email within second and download it right away",
  },
  {
    name: "Guaranteed Quality",
    icon: CheckCircle,
    description:
      "Every asset in our platform is verified by our team to ensure the highest quality",
  },
  {
    name: "For the planet",
    icon: Leaf,
